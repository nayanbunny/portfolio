...
let skillsCircleProgress = () => {
  ...
  var skillsProgress = [
    ...
    { name: 'devops', value: '0.80', color: '#0072cf' },
    { name: 'microservices', value: '0.78', color: '#008e36' },
    { name: 'docker', value: '0.76', color: '#3069de' },
    { name: 'kubernetes', value: '0.72', color: '#3069de' },
    { name: 'api', value: '0.87', color: '#20b199' },
    { name: 'python', value: '0.86', color: '#ffd141' },
    { name: 'genai', value: '0.68', color: '#008e36' },
    { name: 'ml', value: '0.65', color: '#3f319f' },
    { name: 'angular', value: '0.75', color: '#af2b2d' },
    { name: 'react', value: '0.54', color: '#5ed3f3' },
    { name: 'cybersecurity', value: '0.47', color: '#833850' },
